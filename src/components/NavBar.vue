    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark osahan-nav-top p-0">
      <div class="container">
        ...
        >
          <div class="input-group">
            <input
              ...
              placeholder="Search people, posts & more..."
              aria-label="Search"
        ...
        <ul class="navbar-nav ml-auto d-flex align-items-center">
          ...
          <li class="nav-item">
            <router-link to="/boards"
              ><a class="nav-link"
                ...
                ><span class="d-none d-lg-inline">Boards</span></a
              ></router-link
            >
          </li>
          <li class="nav-item">
          ...
          <li
            class="nav-item dropdown no-arrow ml-1 osahan-profile-dropdown"
            v-if="isLoggedIn"
          >
            <a
              class="nav-link dropdown-toggle pr-0"
          ...
          <li class="nav-item" v-if="!isLoggedIn">
            <a class="nav-link"><span class="d-none d-lg-inline">//</span></a>
          </li>
          <li class="nav-item" v-if="!isLoggedIn">
          ...
          <li class="nav-item" v-if="!isLoggedIn">
            <router-link to="/signup"
              ><a class="nav-link"
                ...
                ><span class="d-none d-lg-inline">Signup</span></a
              ></router-link
            >
          </li>
        </ul>
